...
WHERE hist.BlockId like 'PLAYLIST_RM%' and hist.PlayTime between '01.02.2022' and '30.02.2022' and ph_ref.val_str is not null
group by hist.PlayTime, ph.Name, hist.ph_id, ph_ref.val_str, ph_ref_2.val_str, ph_ref_3.val_str, ph_ref_4.val_str
order by hist.PlayTime  -- остсортированы по дате по возрастанию
